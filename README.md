# OpenFedLLM under Label Poisoning Attacks

This repository contains the experimental code for studying **label poisoning attacks** in both **federated** and **decentralized** training settings, built on top of the OpenFedLLM framework.

---

## Overview

This codebase extends the original OpenFedLLM implementation with:

- Support for **label poisoning attack scenarios**
- Multiple **aggregation methods**
- Training pipelines for both:
  - **Federated (centralized) settings**
  - **Decentralized settings**
- Base Model:
  - Qwen2.5-Math-7B for instruction tuning: https://huggingface.co/Qwen/Qwen2.5-Math-7B
  - Llama-3.1-8B for few-shot classification fine-tuning: https://huggingface.co/meta-llama/Llama-3.1-8B
- Datasets:
  - state_tactic_pairs: stored in the directory `data/`. For more information, one can check the paper [REAL-Prover: Retrieval Augmented Lean Prover for Mathematical Reasoning](https://arxiv.org/abs/2505.20613)
  - ag_news: stored in the directory `data/`. For more information, one can check the paper [Character-level Convolutional Networks for Text Classification](https://proceedings.neurips.cc/paper/2015/hash/250cf8b51c773f3f8dc8b4be867a9a02-Abstract.html) and the dataset [link](https://huggingface.co/datasets/wangrongsheng/ag_news)
...
- **Centralized (Federated):**
  - Entry point: `main_cen_sft_instruction.py`
  - Script: `training_scripts/run_cen_sft_instruction.sh`

- **Decentralized:**
  - Entry point: `main_dec_sft_instruction.py`
  - Script: `training_scripts/run_dec_sft_instruction.sh`
...
- This repository is **built upon OpenFedLLM**.
- For detailed information about the original framework, please refer to the **original OpenFedLLM README** included in this project.

---


## ⬇️ Original OpenFedLLM README
