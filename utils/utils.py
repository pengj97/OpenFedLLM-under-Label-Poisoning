...
def set_all_seeds(seed: int, deterministic: bool = True):
    """Set random seeds for Python, NumPy and PyTorch to make experiments reproducible.

    Args:
        seed: integer seed.
        deterministic: if True, set cudnn to deterministic mode and disable benchmark.
    """
