...
# Qwen chat style template. Matches Qwen chat markers used in conversation templates.
# Uses the Qwen chat tokens: <|im_start|>user, <|im_end|>, <|im_start|>assistant
# The final eos token will be appended by the caller via `eos_token`.
qwen_template = """<|im_start|>user\n{}\n<|im_end|>\n<|im_start|>assistant\n{}{}"""

TEMPLATE_DICT = {
    'alpaca': (alpaca_template, '\n### Response:'),
    'vicuna': (vicuna_template, ' ASSISTANT:'),
    'qwen': (qwen_template, '<|im_start|>assistant\n'),
}
